...
--
-- Name: elements unique_val; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_val UNIQUE (symbol, name);
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT f_key FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT type_fkey FOREIGN KEY (type_id) REFERENCES public.types(type_id) ON DELETE CASCADE;
